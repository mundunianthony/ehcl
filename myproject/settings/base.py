...
# Add local development servers to CORS
CORS_ALLOWED_ORIGINS.extend([f'http://{host}:19006' for host in LOCAL_IPS])
...
# Site name for API responses
SITE_NAME = 'Mobi-App API'
