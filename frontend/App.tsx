  ...
  useEffect(() => {
    const initializeNetwork = async () => {
      try {
        ...
        console.log('[App] NetworkManager initialized successfully');
      } catch (error) {
        console.error('[App] Failed to initialize NetworkManager:', error);
        Alert.alert(
          'Network Error',
          'Failed to initialize network connection. Some features may not work properly.',
          [{ text: 'OK' }]
        );
      }
    };
